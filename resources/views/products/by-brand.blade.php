...
@section('title', 'Sản phẩm ' . $brandName . ' - HP Sneakers')
...
<div class="bg-gray-100 py-4">
    <div class="container mx-auto px-4">
        <nav class="flex items-center text-sm text-gray-600">
            ...
            <span class="text-gray-800 font-medium">Thương hiệu {{ $brandName }}</span>
        </nav>
    </div>
</div>
...
<section class="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-12">
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-4xl md:text-5xl font-bold mb-2">{{ $brandName }}</h1>
...
<section class="container mx-auto px-4 py-12">
    ...
    <div class="text-center py-16">
        ...
        <p class="text-gray-600 mb-8">
            Hiện tại chúng tôi chưa có sản phẩm nào của thương hiệu <strong>{{ $brandName }}</strong>.
        </p>
...
@push('scripts')
<script>
    // Sort functionality (có thể mở rộng sau với AJAX)
